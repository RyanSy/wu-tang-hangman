...
var wordsList   = ["RZA", "GZA", "OLDIRTYBASTARD", "INSPECTAHDECK", "RAEKWON", "UGOD", "GHOSTFACEKILLAH", "METHODMAN"];
...
function roundComplete(){
	...
	if (lettersInChosenWord.toString() == blanksAndSuccesses.toString()) {
		...
		// playAudioWin(); // play audio clip
		alert("You win! WU-TANG forever!"); // give the user an alert
	...
	// If we've run out of guesses
		...
		playAudioLose(); // play audio clip
		alert("You lose! You best protect ya neck!"); // give the user an alert
...
document.onkeyup = function(event) {
	letterGuessed = String.fromCharCode(event.keyCode).toUpperCase(); // converts all key clicks to uppercase letters
...
// ==================================================================================================
var triumph = document.getElementById("triumph");
var protectYaNeck = document.getElementById("protectYaNeck"); 
